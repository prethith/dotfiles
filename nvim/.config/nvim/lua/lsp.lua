...
local setup_treesitter = function()
  ...
  local ensure_installed = {
    "astro", "bash", "c", "c_sharp", "cmake", "cpp",
    "css", "csv", "go", "html", "java", "javascript",
    "json", "lua", "markdown", "meson", "ocaml",
    "odin", "python", "r", "rust", "sql", "svelte",
...
local function lsp_on_attach(ev)
  ...
  vim.keymap.set("n", "<C-i>", function() Snacks.picker.lsp_implementations() end, opts)
  vim.keymap.set("n", "<leader>fn", function() Snacks.picker.lsp_references() end, opts)
